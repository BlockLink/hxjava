...
import cash.hx.hxjava.exceptions.AddressException;
...
public class Address {
    ...
    public static final String ADDRESS_PREFIX = "HX"; // mainnet prefix
    public static final String TESTNET_ADDRESS_PREFIX = "HXT"; // testnet prefix

    private byte[] addy;
    private byte version; // AddressVersion
    ...
    public static Address fromString(String addrString, String addrPrefix) throws AddressException {
        if(addrString==null || addrString.length() <= addrPrefix.length()) {
            throw new AddressException("invalid address length");
        }
