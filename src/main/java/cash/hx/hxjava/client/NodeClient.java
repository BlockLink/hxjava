...
import cash.hx.hxjava.serializer.Uint32Serializer;
...
public class NodeClient implements Closeable {
    ...
    private String nodeRpcEndpoint; // hx_node的websocket rpc endpoint
